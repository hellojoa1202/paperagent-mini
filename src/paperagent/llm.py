"""Provider-independent LLM wrapper for PaperAgent."""
...
def ask_llm(system_prompt: str, user_prompt: str, model: str | None = None) -> str:
    ...
    raise ValueError(
        "LLM_PROVIDER must be one of: anthropic, openai, xai, ollama, lmstudio, groq, exaone"
    )
