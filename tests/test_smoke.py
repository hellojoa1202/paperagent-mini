...
def test_settings_defaults() -> None:
    ...
    assert settings.research_gap_experiment_count == 3
    assert settings.prototype_max_repairs == 2
    assert settings.prototype_execute is True
